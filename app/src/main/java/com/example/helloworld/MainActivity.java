...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnbinary = (Button) findViewById(R.id.btn_binary);//10转2
        ...
        Button btnoctal = (Button) findViewById(R.id.btn_octal);//10转8
        ...
        Button btnhexadecimal = (Button) findViewById(R.id.btn_hexadecimal);//10转16
        ...
        Button btnbinary2 = (Button) findViewById(R.id.btn_binary2);//2转10
        ...
        Button btnbinary3 = (Button) findViewById(R.id.btn_binary3);//8转10
        ...
        Button btnbinary4 = (Button) findViewById(R.id.btn_binary4);//16转10
